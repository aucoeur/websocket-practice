# FEW 2.9 Websockets In-Class Review

## [Challenges](#websocket-challenges)

- [x] Challenge 1 - Implement and test websocket example
- [x] Challenge 2 - Mod the client - `<ul><li>...</li></ul>`
- [x] Challenge 3 - Mod the client - Add `names`
- [x] Challenge 4 - Style the client - Unique colors for names
